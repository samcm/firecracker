...
class JailerContext:
    ...
    def __init__(
        ...
        **extra_args,
        ...
        `scratch_fd` is the number of the descriptor holding the writable
        scratch block device image, a regular non-empty file opened
        `O_RDWR | O_DIRECT`.
    ...
    def construct_param_list(self):
        ...
        if self.scratch_fd is not None:
            jailer_param_list.extend(["--scratch-fd", str(self.scratch_fd)])
